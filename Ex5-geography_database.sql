...
CREATE DATABASE IF NOT EXISTS `ex5-geography` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ex5-geography`;
...
#5
create database `ex5-online_store`;
use `ex5-online_store`;
...
#6
create database `ex5-University`;
use `ex5-University`;
