...
CREATE DATABASE IF NOT EXISTS `ex3-geography` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ex3-geography`;
...
#11
select p.peak_name,  r.river_name,lower(concat(p.peak_name, r.river_name)) AS mix
from peaks p
join rivers r
